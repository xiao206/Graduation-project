  ...
  <view class="page">
    <view class="card">
      ...
      <view class="block">
        ...
        <input v-model="username" class="input" placeholder="2~20 个字符" placeholder-class="ph" />
      </view>

      <view class="block">
        <text class="k">密码</text>
        <input v-model="password" class="input" password placeholder="至少 4 位" placeholder-class="ph" />
      </view>
